...
int main(int argc, char **argv){
    ...
    string pipeStrGoblin = "qtiqmmfsrc name=qmmf af-mode=3 ! video/x-raw, format=NV12, width=640,  height=480, framerate=30/1, camera=0 ! qtivtransform rotate=1 ! appsink name=goblin_sink max-buffers=2 sync=1 caps=video/x-raw,format=BGR throttle-time=500000000";
    GError *err = nullptr;
